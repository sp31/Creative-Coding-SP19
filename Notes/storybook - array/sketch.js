...
var currentImage = 0;
var story = ["There was a dinosaur","and he liked to dance","and the meteor was coming","and then it passed."];

//declaring it empty because of the load image function
var imageArray = [];
