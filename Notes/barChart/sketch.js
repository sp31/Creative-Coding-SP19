...
function preload() {
  //specify header row so it doesn't appear as a main row
...
//gives largest number in group of numbers, (...data) converts data array into individual numbers
    var maxData = Math.max(...data) + 10;
    //map function sub-divides two ranges
